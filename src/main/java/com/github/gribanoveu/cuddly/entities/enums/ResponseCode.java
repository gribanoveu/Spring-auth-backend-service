package com.github.gribanoveu.cuddly.entities.enums;
...
public enum ResponseCode {
    SERVER_ERROR(
            ...
            "Server Error. Try refreshing the page or returning later. Contact your administrator if the problem still exists.",
